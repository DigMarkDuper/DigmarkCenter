...
def check_password():
    ...
    with col_mid:
        # 1. Kita buat variabel teks HTML-nya dulu agar tidak pusing dengan tanda kutip
        login_html = """
        ...
        # 2. EKSEKUSI: Panggil variabel tadi di sini
        # PERHATIKAN: Parameter unsafe_allow_html HARUS ada di sini

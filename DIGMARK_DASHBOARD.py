...
# --- HALAMAN 3: INSIGHTS & ANALYTICS ---
    ...
    with st.expander(
        "🚀 Ultra-Smart Importer (TikTok & Instagram)",
        expanded=True
    ):

        st.info(
            "💡 Pilih file CSV TikTok/Instagram. "
            "Tombol simpan muncul jika file dikenali."
        )
        ...
        if files:
            ...
            for f in files:
                ...
                try:
                    ...
                    # ==================================================
                    # 1. DETEKSI ENCODING YANG LEBIH KUAT
                    # ==================================================
                    content = []
                    ...
                    if "videoviews" in sample_text:
                        ...
                        res_tk['View'] = df_tk.get(
                            'Video Views',
                            0
                        )

                        res_tk['Reach'] = df_tk.get(
                            'Video Views',
                            0
                        )
                        ...
                        res_tk['Profile Visit'] = df_tk.get(
                            'Profile Views',
                            0
                        )
                    ...
                    # ==================================================
                        ...
                        if target:
                            ...
                            logs.append(
                                f"✅ Instagram {target}: {f.name}"
                            )

                        else:
                            logs.append(
                                f"❓ File tidak dikenali: {f.name}"
                            )
